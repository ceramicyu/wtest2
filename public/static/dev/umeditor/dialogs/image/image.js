...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="fileList" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
        ...
        uploadComplete: function(r){
            ...
            try{
                var json = eval('('+r+')');
                console.log(json);
                Base.callback(me.editor, me.dialog, json.data, json.msg == 0 ? 'SUCCESS' : json.param);
            }catch (e){
        ...
        submit: function (callback) {
            ...
            var me = this,
                input = $( '<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="fileList" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
                input = input[0];
